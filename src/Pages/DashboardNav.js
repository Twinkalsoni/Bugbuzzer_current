...
<Button style={{color:'black', fontWeight:'bold' ,textTransform:'capitalize'}} size='medium' variant='text'>
Hire Experts  </Button>
<Link to="/dashboard/Question-form" style={{textDecoration:"none"}} >
<Button variant="contained" size='small' style={{backgroundColor:"#D82148",textDecoration:"none", textTransform:'capitalize',border:'2px solid #D82148', marginRight:'18px', fontWeight:'bold'}} sx={{borderRadius:2}}>Ask question</Button>
</Link>
  </Box>
